...
from app.domain.speed_ticks import min_spd_for_tick
...
def optimize_arena_rush(account: AccountData, presets: BuildStore, req: ArenaRushRequest) -> ArenaRushResult:
    ...
    global_offense_result = optimize_greedy(
        ...
        GreedyRequest(
            ...
            excluded_rune_ids=set(global_locked_runes),
            excluded_artifact_ids=set(global_locked_artifacts),
    ...
    for row in offense_cfg_rows:
        ...
        if int(penalty) > 0:
            ...
            for uid in fixed_shared_uids:
                g = by_uid_global_result.get(int(uid))
                if g is None:
                    continue
            ...
            repair_kwargs = dict(
                ...
                excluded_rune_ids=(set(global_locked_runes) | used_outside_runes) - fixed_rune_ids,
                excluded_artifact_ids=(set(global_locked_artifacts) | used_outside_artifacts) - fixed_artifact_ids,
            ...
            if rep_speed_by_uid and len(rep_speed_by_uid) == len(expected_order) and int(rep_pen) > 0:
                ...
                if cap_map:
                    ...
                    repair_kwargs3["unit_max_final_speed"] = dict(cap_map)
